...
define('simple-uuid', ['simple-uuid/uuid'], function (main) { return main; });

define("simple-uuid/uuid", function(){});
...
define('md5', ['md5/md5'], function (main) { return main; });

define("md5/md5", function(){});
...
Pouch.adapter('idb', IdbPouch);
 return Pouch })
;
define('pouchdb', ['pouchdb/pouch.amd.alpha'], function (main) { return main; });

define("pouchdb/pouch.amd.alpha", function(){});
...
(function (root, factory) {
    if (typeof exports === 'object') {
        ...
        define('backbone-pouchdb/backbone-couchdb',['backbone'], factory);
    } else {
        // Browser globals
...
(function (root, factory) {
    if (typeof exports === 'object') {
        ...
        // AMD. Register as an anonymous module.
        define('backbone-pouchdb/backbone-pouchdb',['backbone', 'pouchdb', './backbone-couchdb'], factory);
    } else {
        // Browser globals
...
define('backbone-pouchdb', ['backbone-pouchdb/backbone-pouchdb'], function (main) { return main; });
