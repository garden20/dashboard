...
exports.settings = function(doc, req) {
    ...
    var scripts = [
        ...
        "jam/json.edit/addons/autocomplete_select.js",
        "jam/json.edit/addons/textarea.js",
        "jam/json.edit/addons/enumlabels.js",
...
exports.update = function(doc, req) {
    ...
    var content = templates['update.html']({
        app_url: req.query.app_url,
        login_link: '../login?redirect=update/' + req.query.app_url,
        baseURL: utils.getBaseURL(req),
        is_auth : is_auth,
        host_options : JSON.stringify(settings.host_options),
